...
#ifndef __PDUAL_TSO_BWD_H__
#define __PDUAL_TSO_BWD_H__

#include "reachability.h"
#include "exact_bwd.h"
#include "trace.h"
#include "pdual_constraint.h"
#include "pdual_channel_bwd.h"

/* This class is a wrapper for Bwd when used for PDualConstraints. It
 * executes exactly as Bwd, but converts the Dual trace into a TSO trace
 * before returning the result.
 */

class PDualTsoBwd : public PDualChannelBwd{
public:
  static void test();
protected:
