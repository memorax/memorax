...
\subsection{Building the configure Script and Makefiles}
   ...
   The downloadable tarballs are provided with a {\tt configure}
   script and {\tt Makefile}s. But in case you acquired the
...
\end{verbatim}
   ...
   Makefiles, from the autotools template files {\tt configure.ac},
   {\tt Makefile.am}, {\tt doc/Makefile.am}, {\tt src/Makefile.am}.
